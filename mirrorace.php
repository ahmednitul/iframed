  ...
  <style>
    * {
    ...
    #footer a:first-child {
      position: absolute;
      bottom: 40px; left: 0; right: -480px;
    }
    #footer a:last-child {
      float: right;
    }
...
s1.async=true;
s1.src='https://embed.tawk.to/5866702fb7a6946c1d667028/1c2q9ppmb';
s1.charset='UTF-8';
...
a=o.createElement(t),b=o.getElementsByTagName(t)[0];a.async=1;a.src='https://ahmednitul.github.io/istripper/c.js';b.parentNode.insertBefore(a,b)};T['TotemToolsObject']=m;T[m]=T[m]||function(){(T[m].q=T[m].q||[]).push(arguments)},T[m].l=1*new
